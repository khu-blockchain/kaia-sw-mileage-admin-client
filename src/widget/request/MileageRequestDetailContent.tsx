...
const MileageRequestDetailContent = () => {
  ...
  const { data: { swMileageDetail, activityFieldList } } = useGetSwMileageById({
  ...
  const detailContentMapper = useMemo(() => {
    return {
      student: {
        ...
        walletAddress: {
          label: "지갑 주소",
          value: sliceWalletAddress(swMileageDetail.wallet_address.toUpperCase()),
        },
        email: {
          label: "이메일",
  ...
  return (
    ...
    <div className="flex gap-2">
     ...
     <ApproveMileageDialog swMileage={swMileageDetail} activityFieldList={activityFieldList}>
